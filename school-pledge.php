...
<head>
    <title>Gracedew International School | School Pledge</title>
    ...
    <meta property="og:title" content="Gracedew International School | School Pledge" />
    ...
    <meta name="twitter:title" content="Gracedew International School | School Pledge" />
    ...
    <script type="application/ld+json">{"@context":"https://schema.org","@type":"WebPage","name":"Gracedew International School | School Pledge","description":"Fill out the Preliminary Inquiry form. (Add a Passport Picture of your child).","image":"https://wonderworldinternationalschool.com/assets/images/banner.jpg"}</script>
    <meta charset="utf-8">
            ...
            <div class="container py-5">
                ...
                <nav aria-label="breadcrumb animated slideInDown">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item text-white active" aria-current="page">School Pledge</li>
                    </ol>
                </nav>
            </div>
        </div>
        ...
        <div class="container-xxl py-5">
            <div class="container">
                <div class="mb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 600px;">
                    <h1 class="mb-3">School Pledge</h1>
                    <p></p>
                </div>
                <div class="row">                        
                <div class="col-md-8 wow fadeInUp" data-wow-delay="0.1s">

                    <p class="wow fadeInUp" data-wow-delay="0.2s">I pledge today to do my best in reading, math and all the rest.</p>
<p class="wow fadeInUp" data-wow-delay="0.2s">I promise to obey the rules in my class and in the school</p>
<p class="wow fadeInUp" data-wow-delay="0.2s">I will respect myself and others too.</p>
<p class="wow fadeInUp" data-wow-delay="0.2s">I will expect the best in all I do.</p>
<p class="wow fadeInUp" data-wow-delay="0.2s">I am here to learn all I can to try my best and be all I am
So help me God.</p>
