...
<head>
    <title>Gracedew International School | School Anthem</title>
    ...
    <meta property="og:title" content="Gracedew International School | School Anthem" />
    ...
    <meta name="twitter:title" content="Gracedew International School | School Anthem" />
    ...
    <script type="application/ld+json">{"@context":"https://schema.org","@type":"WebPage","name":"Gracedew International School | School Anthem","description":"Fill out the Preliminary Inquiry form. (Add a Passport Picture of your child).","image":"https://wonderworldinternationalschool.com/assets/images/banner.jpg"}</script>
    <meta charset="utf-8">
            ...
            <div class="container py-5">
                ...
                <nav aria-label="breadcrumb animated slideInDown">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item text-white active" aria-current="page">School Anthem</li>
                    </ol>
                </nav>
            </div>
        </div>
        ...
        <div class="container-xxl py-5">
            <div class="container">
                <div class="mb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 600px;">
                    <h1 class="mb-3">School Anthem</h1>
                    <p></p>
                </div>
                <div class="row">
                <div class="col-md-8 wow fadeInUp" data-wow-delay="0.1s">

                    <p class="wow fadeInUp" data-wow-delay="0.2s">O praise God Gracedewers </p>
<p class="wow fadeInUp" data-wow-delay="0.2s">For what you have done for us </p>
<p class="wow fadeInUp" data-wow-delay="0.2s">Make our school be the best among the rest </p>
<p class="wow fadeInUp" data-wow-delay="0.2s">Intelligence is our portion now and forever </p>
<p class="wow fadeInUp" data-wow-delay="0.2s">Intelligence is our portion now and forever. </p>
                </div>
                <div class="col-md-4">
                        <?php
