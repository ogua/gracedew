...
<head>
    ...
    <meta charset="utf-8">
    <meta name="description" content="Our latest gallery, images of photos,Carrier Day celebration,School Premises among others.">
  ...
  <meta property="og:description" content="Our latest gallery, images of photos,Carrier Day celebration,School Premises among others." />
  ...
  <meta name="twitter:description" content="Our latest gallery, images of photos,Carrier Day celebration,School Premises among others." />

  <script type="application/ld+json">{"@context":"https://schema.org","@type":"WebPage","name":"Gracedew International School | Our Services","description":"Our latest gallery, images of photos,Carrier Day celebration,School Premises among others.","image":"https://wonderworldinternationalschool.com/assets/images/banner.jpg"}</script>
            ...
            <div class="container">
                <div class="row g-4">
                    <div class="offset-2 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                        <div class="classes-item">
                            ...
                            <div class="bg-light rounded p-4 pt-5 mt-n5 text-center">
                                <a class="d-block text-center h3 mt-3 mb-4" href="photos.php">Photos</a>
                                <a href="photos.php" class="btn btn-primary rounded-pill px-3 d-lg-block">View Gallery<i class="fa fa-arrow-right ms-3"></i></a>
                    ...
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                        <div class="classes-item">
                            <div class="bg-light rounded-circle w-75 mx-auto p-3">
                                <img class="img-fluid rounded-circle" src="img/g2.jpg" alt="">
                            </div>
                            <div class="bg-light rounded p-4 pt-5 mt-n5 text-center">
                                <a class="d-block text-center h3 mt-3 mb-4" href="videos.php">Videos</a>
                            <a href="videos.php" class="btn btn-primary rounded-pill px-3 d-lg-block">View Gallery<i class="fa fa-arrow-right ms-3"></i></a>
                            </div>
