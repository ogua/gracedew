...
<head>
    <title>Gracedew International School | Home</title>
    ...
    <script type="application/ld+json">
        {
            ...
            "@type": "WebPage",
            "name": "Gracedew International School | Home",
            "description": "Welcome to the official website of Gracedew International School, get all the latest information about Gracedew International School.",
...
<body>
    ...
    <div class="facility-icon bg-custom">
    <span class="bg-custom"></span>
    <i class="fa fa-bus-alt fa-3x text-custom"></i>
    <span class="bg-custom"></span>
    </div>
    <div class="facility-text bg-custom">
    <h3 class="text-custom mb-3">School Bus</h3>
    ...
    <video width="100%" height="auto" title="WELCOME TO Gracedew International School" style="background-color: #000;"controls>
